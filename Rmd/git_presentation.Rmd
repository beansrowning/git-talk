...
- submodules, CI/CD, Merge requests
- How to exit Vim

```{r exit-vim}
include_graphics("../img/vim.png")
```

## Why should we care?

*Axiom:* Proficiency in collaborative tools drives innovation

- All of your friends (and collaborators) are already using it
- It's not enough to merely know that the tools exist if we can't apply them practically
- It's not going away

<div class="notes">
Consider: Some of the first case counts of COVID-19 in China we were getting from GitHub.
</div>

## A bit about me

- CDC/ATSDR RUG Chair
- MSc. Epidemiology from LSHTM
- Daily Git user
...
## Git clients currently allowed by CDC | Git for Windows  
...
## Git clients currently allowed by CDC | RStudio  

- Yep! It's always been there!
- Code and manage Git from one program  
- UI is on the basic side  

<div class="columns-2">

```{r rstudio-1, out.width = "350px"}
include_graphics("../img/rstudio_1.png")
```
<p class="forceBreak"></p>
```{r rstudio-2, out.width = "350px"}
include_graphics("../img/rstudio_2.png")
```

</div>

## Git clients currently allowed by CDC | Github Desktop
...
```{r vscode, out.width = "400px"}
include_graphics("https://code.visualstudio.com/assets/docs/editor/versioncontrol/merge-conflict.png")
```
...
```{r sourcetree, out.width = "400px"}
include_graphics("https://www.sourcetreeapp.com/dam/jcr:580c367b-c240-453d-aa18-c7ced44324f9/hero-mac-screenshot.png")
```
...
## Enter the multiverse | branching
...
- Also used to "un-modify" a file (ie. modified -> unmodified)
    - `git checkout -- <file>`
    - **This effectively erases your unsaved progress!**  
...
- If you can't get it sorted, shoot me an email!  
